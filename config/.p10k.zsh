# Generated by Powerlevel10k configuration wizard on 2022-02-01 at 18:49 EST.
...
# 2 lines, solid, light-ornaments, sparse, concise, instant_prompt=quiet.
...
() {
  ...
  function my_git_formatter() {
    ...
    # TPR - remove git branch truncation
